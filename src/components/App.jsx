...
function App() {
  //useState hook to setContact information
  ...
  function handleChange(event) {
    //destructured object to capure the name and value of input boxes
    const {name, value} = event.target

    setContact((prevValue) => {
      //if the name value is equal to "fName" set contact info to the 'value'
      if (name === "fName") {
        return {
          fName: value,
